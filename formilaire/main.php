...
<body>
    ...
    <ul id="table">
        ...
        <li><a href="impr.php">IMPRIMANTES</a></li>
        <li><a href="pointage.php">HORODATEURS DE POINTAGE</a></li>
        <li><a href="controle.php">CONTRÔLE D'ACCES</a></li>
        <li><a href="enregist.php">CAISSES ENREGISTREUSES</a></li>
